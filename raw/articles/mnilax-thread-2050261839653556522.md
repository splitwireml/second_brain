...
type: "thread"
tags: [claude-code, coding-agents, optimization, productivity]
...
2. Aggressive /clear between every task.
...
3. Disabling all skills entirely.
...
5. Pure subscription downgrade (Pro -> less expensive plan).
Doesn't work. The cost per work-hour stayed the same, just got more painful when limits hit.

6. Trying to identify the March 2026 caching bug.
...
If this saved you a week of Claude limit pain, repost. Part 2 next week..
