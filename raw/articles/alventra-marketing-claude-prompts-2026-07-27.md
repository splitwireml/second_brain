---
source_url: https://alventramarketing.com/claude-prompts/
ingested: 2026-07-27
sha256: 739536c6514a7dd7fa6ec6e2267ceff331adcbf5a54a4c6cc9dbfd8a72f83182
capture_method: visible-text extraction from public HTML; article body selected from title through author link
related_source: raw/articles/bloggersarvesh-claude-seo-100k-month-playbook-2032130279494853118.md
---
Top 22 Claude Prompts For SEO – The Only Stack You’ll Ever Need.
THIS IS THE ARTICLE I WASN’T GOING TO PUBLISH.
Claude Cowork is now my Chief of SEO. I’m giving the exact prompts away for free.
...
Not surface level. the actual prompts. the thinking behind them. and why each one moves your rankings. Save this. you’ll need it.
What Claude Cowork Actually Does For My SEO
Before I open a single tab, Claude Cowork already knows my business.
My service area. my competitors. my Google Business Profile. My review velocity. Which categories am I missing? Which citations have the wrong phone number? all of it loaded in before I say a word.
...
The first time I watched it pull competitor category data, map it against map pack rankings, and highlight every category I was missing – I just stared at the screen.
That analysis alone used to take half a day per client. Now it takes minutes.
What I built
...
My Google Business Profile details are uploaded so Claude knows my current categories, attributes, photos, and services before i ask anything
...
why this matters:
10 reviews a month, each response mentioning your service and city -that’s 120 pieces of keyword-rich content on your GBP per year that you didn’t have before. and the template system means you respond to any review in under 60 seconds.
...
why this matters:
the competitor analysis almost always reveals the same thing: nobody’s posting.
...
why this matters:
your services section is one of the only places on your GBP where you control the text completely. reviews are written by customers.
...
why this matters:
having 3 versions lets you test. run version 1 for 30 days, check impressions and calls, then try version 2.
...
why this matters:
most businesses are sitting on page 2 rankings that are one title tag change away from page 1. this audit finds them all and tells you exactly what to fix first – no guesswork, no wasted effort.
...
why this matters:
Google ranks pages not websites. if you don’t have a page specifically about [service] in [city], you will not rank for that search. this prompt builds the entire location page stack in one session – the work that would take a team of writers weeks gets done before lunch.
...
why this matters:
page 2 keywords are the lowest hanging fruit in all of SEO. someone is already searching for exactly what you offer – you’re just one optimization push away from being visible. this prompt finds every single one of them and tells you exactly what to write.
...
why this matters:
most businesses write their own website copy about themselves. the businesses that dominate write their copy in the language their customers actually use. review sentiment analysis finds that language – the exact words that make a stranger trust you enough to call. this is what conversion rate optimisation actually looks like for local businesses.
...
why this matters:
2-4 real contextual links per month compounds faster than 20 random directory submissions. this audit removes all the guesswork – you know exactly who to target, exactly how they earned the link, and exactly what to say when you reach out.
...
why this matters:
Content that ranks for problem-awareness searches turns your website into a 24/7 sales tool. someone searching ‘why is my furnace making noise’ is one step away from calling a HVAC company.
...
"I want to build and strengthen my business entity in Google's knowledge graph to improve local rankings and potentially trigger a knowledge panel. My business details are: Name: [exact business name], Address: [full address], Phone: [phone number], Website: [URL], GBP: [GBP URL], Founded: 2026, Owner name: [your name], Industry: [industry].
...
why this matters:
GBP posting is not just about frequency. it’s about pattern.
...
21. Detailed OnPage SEO Audit
“You are now my Head of On-Page SEO. You have 14 years of experience optimising local business and service pages, you’ve personally pushed thousands of pages from page 2 into the top 3, and you don’t tolerate generic advice. You speak in specifics. When you say something is broken, you tell me exactly what to replace it with — not the principle, the actual copy.
Open Chrome and fetch this page: [URL] – https://thedallasroofers.com/
The target keyword for this page is: [TARGET KEYWORD] – roof replacement dallas
Also open the top 5 ranking pages on Google for [TARGET KEYWORD] in an incognito tab and skim them. I want every recommendation you give me benchmarked against what’s actually ranking — not against textbook SEO theory.
Now run a full on-page SEO audit. Do not skip sections. Do not summarise. Work through every element below in order.
SECTION 1: THE NON-NEGOTIABLES (title, meta, URL, H1)
For each of the four elements below give me a table with these columns: Element | Current | Character / Word Count | Score (0–10) | What’s Wrong | Exact Rewrite | Why This Wins.
Title tag — must be under 60 characters, must lead with the target keyword, must include a hook (number, year, modifier, or location). Tell me if the keyword is buried, if it’s keyword-stuffed, or if it sounds AI-written.
Meta description — must be under 155 characters, must include the keyword once naturally, must end with a CTA. Don’t just rate it. Rewrite it.
URL slug — must be short, must contain the keyword, must have no stop words or dates unless intentional. If the slug is wrong, tell me whether to redirect (and write the 301 line) or leave it.
H1 — there must be exactly one H1, it must contain the target keyword, and it must match search intent for [TARGET KEYWORD]. If the current H1 is wrong, give me the exact replacement H1 — word for word — and explain in 2 sentences why this version beats the current one for both Google and the human reader.
SECTION 2: HEADING STRUCTURE (H2, H3, H4)
Pull every heading on the page in order. Build a nested outline showing the current hierarchy. Then build a second outline showing the correct hierarchy.
For H2s tell me:
Is each H2 tagged correctly or is it a styled paragraph pretending to be a heading?
Does each H2 cover a sub-topic the top-ranking pages cover? List any sub-topics missing.
Are H2s using semantic variations of the keyword (LSI / NLP entities) or are they generic?
Rewrite every weak H2 word for word. Give me the exact text I should paste in.
For H3s tell me:
Are they nested under the right H2 or floating?
Are any H3s actually doing the job of an H2 (or vice versa)?
Where should I add new H3s to capture People Also Ask questions for [TARGET KEYWORD]?
Output the full corrected heading outline at the end of this section as a clean indented list I can hand to a writer.
SECTION 3: PARAGRAPH AND BODY COPY CRITIQUE
Read the body copy as a 14-year SEO would, not as a writer. For each of the following give me a verdict and a rewrite where needed:
Opening paragraph (first 100 words) — does the keyword appear in the first sentence? Does it answer the search intent immediately or does it warm up with fluff? Rewrite the opening 100 words from scratch if it’s weak.
Paragraph length — flag every paragraph over 4 lines. Mobile users bounce.
Keyword usage — give me the natural keyword density, count of exact-match mentions, and count of semantic variations. Flag stuffing and flag under-use.
Entity coverage — list the top 10 NLP entities the ranking pages cover that this page is missing. Tell me where to insert each one.
Thin sections — flag any section under 75 words that should be expanded. Write the expansion copy.
Fluff and AI tells — flag sentences that say nothing (“In today’s fast-paced world…”, “When it comes to…”, “Whether you’re…”). Rewrite them or delete them.
CTA placement — count the CTAs above the fold, mid-page, and at the bottom. Tell me what’s missing and write the exact CTA copy.
SECTION 4: SUPPORTING ON-PAGE ELEMENTS
Give me a table: Element | Status | Issue | Fix.
Image count, image alt text (list every image with its current alt text and the alt text it should have)
Image file names (flag IMG_2453.jpg style names)
Internal links out (count, anchor text quality, are they pointing to money pages?)
Internal links in (which pages on the site should be linking to this one — name them)
External links (do any point to competitors? are any broken?)
Schema markup present (LocalBusiness, Article, FAQ, Breadcrumb, Review — which exist, which are missing). If FAQ schema is missing and the page has Q&A, write the JSON-LD ready to paste.
Open Graph and Twitter card tags
Word count vs the average word count of the top 5 ranking pages (give me the gap)
Table of contents present? Should there be one?
Featured snippet opportunity — is there a section formatted as a definition, list, or table that could win position 0? If not, write one.
SECTION 5: SEARCH INTENT MATCH
In one paragraph: does this page actually match the intent behind [TARGET KEYWORD]? Is the searcher looking for information, a comparison, or to hire/buy? Does the current page deliver that? If not, tell me bluntly what type of page this should have been.
SECTION 6: THE FINAL SCORECARD
Build me a single summary table:
Area
Score /10
Priority
Time to Fix
...
Schema
Search intent match
Overall on-page score
SECTION 7: THE WORDPRESS FIX-IT CHECKLIST (this is the most important section)
The person reading this owns the business. They are not a developer. They know how to log into WordPress and use the Gutenberg block editor. They probably have Yoast SEO or Rank Math installed. Write them a numbered, top-to-bottom action list they can execute themselves in one sitting.
For every single fix, write it like this:
Fix #X — [Plain English name of the fix]
What to do: one sentence.
Where to click: exact path. Example: “WP Admin → Pages → All Pages → click [page title] → scroll to the Yoast SEO box at the bottom → SEO tab → Meta description field.”
What to paste: the exact text, in a code block, ready to copy.
Time: estimated minutes.
Impact: High / Medium / Low.
Order the checklist by impact, not by section. The first 5 fixes should be the ones that move rankings fastest. The last fixes should be polish.
End the checklist with one sentence: “If you only do the first three, you’ll still see movement within 14–30 days.”
RULES FOR YOUR ENTIRE OUTPUT:
Never give generic advice. “Make the H1 more keyword-rich” is banned. Give me the H1.
Never say “consider adding…” — say “add this:” and write it.
Use tables wherever you’re comparing.
Use plain English in the WordPress section. No jargon without a one-line translation.
If something is already good, say so in one line and move on. Don’t pad.
If you’re unsure about something on the page (paywalled, JS-rendered, blocked), tell me — don’t guess.”
How to use it: swap in the URL, the target keyword, optional secondary keywords, and a location if it’s a local page. That’s it.
22. Backlinks Audit
Role: You are acting as my senior SEO analyst. You have Ahrefs access in Chrome and I’m already logged in. Do NOT re-authenticate, do NOT create new accounts, do NOT change any account settings. If you hit a login wall or a paywalled feature, stop and tell me — don’t try to work around it.
Goal: Run a competitive backlink gap analysis for the keyword {{KEYWORD – roof replacement austin}} so I know exactly how many referring domains I need (and at what DR tiers) to realistically rank in the top 5.
Phase 1 — SERP and backlink baseline
Open a new Chrome tab and go to https://app.ahrefs.com/keywords-explorer.
Set country to United States (unless I’ve told you otherwise in this chat) and search for: {{KEYWORD – roof replacement austin}}.
Wait for the page to fully load. Record these headline metrics into a running notes doc (create a Google Doc titled Backlink Gap — {{KEYWORD – roof replacement austin}} or keep it in your scratchpad if Docs isn’t connected):
Keyword Difficulty (KD)
Global + US search volume
“Traffic potential” of the #1 page
The “SERP Overview” section — that’s our working data.
In the SERP Overview table, capture the top 10 organic results (skip ads, featured snippets that aren’t organic, People Also Ask, video carousels, and any result from
{{MY_DOMAIN – https://j-connroofing.com/}}).
For each row, note:
Rank position
Page URL (the exact ranking URL, not just the root domain)
Domain Rating (DR) of the root domain
URL Rating (UR) of the page
Referring domains to the page (this is the number that actually matters — not domain-level RDs)
Backlinks to the page
Estimated organic traffic to the page
From that top 10, pick the top 5 ranking pages we’ll drill into. If any of the top 5 are YouTube, Reddit, Wikipedia, Quora, or similar UGC/platform domains, flag them separately — they play by different rules and shouldn’t anchor our backlink target.
Replace them with the next organic result down so we end up with 5 “normal” competitor pages where possible. Tell me which ones you swapped and why.
Phase 2 – Per-competitor backlink drill-down
For each of the 5 competitor pages, do the following in sequence (not in parallel — one at a time so we don’t lose state):
From the SERP Overview, click the backlinks number for that row. This should open Site Explorer → Backlinks report, scoped to that exact URL with “Exact URL” mode selected. Verify the scope dropdown is set to Exact URL, not Prefix or Domain. If it isn’t, change it.
Apply these filters in the Backlinks report, in this order:
Link type: Dofollow only
One link per domain: Enabled (toggle at the top of the report)
Language: English (unless I told you the keyword is in another language)
Platform: leave as “All”
Sort by DR descending
Wait for the filtered list to load. Now capture the full filtered set — or the top 100 if the list is longer than that. For each backlink row, note:
Referring page URL
Referring domain
DR of the referring domain
Anchor text (truncate to 60 chars)
Link type confirmation (should all be dofollow after filter)
First seen date
Bucket the referring domains by DR tier:
DR 70+ (high authority)
DR 50–69 (mid authority)
DR 30–49 (low-mid authority)
DR 0–29 (low authority / likely low-value)
Also count and separately flag: niche-relevant links (links from sites whose homepage/topic clearly matches {{KEYWORD}}‘s topic) vs generic/off-topic links. Use your judgment from the referring domain name and, if you’re unsure on 2–3 of them, open them in a new tab to check — don’t open every single one, that’s wasteful.
Save the data for that competitor before moving to the next one. Treat each competitor as a checkpoint.
Phase 3 – Analysis and recommendation
Once all 5 competitors are captured, compute and present:
Averages across the 5 pages (post-filter, dofollow + one-per-domain only):
Mean referring domains
Median referring domains (call this out — mean gets skewed by one outlier)
Mean DR of referring domains
Mean UR of the ranking page
Mean DR of the ranking root domain
DR tier distribution –
for the average competitor, how many RDs in each tier (70+, 50–69, 30–49, 0–29).
My target – give me a concrete number:
“To realistically compete for top 5, you need roughly X referring domains (dofollow, unique), distributed approximately: A in DR 70+, B in DR 50–69, C in DR 30–49.”
Base the number on the median, not the mean, and add a 10–15% buffer. Explain the buffer.
If my current DR is much lower than the competitor average, say so explicitly and tell me the gap matters more than raw link count.
Quality signal check –
call out anything suspicious in the competitor backlink profiles: PBN patterns (multiple RDs with near-identical anchor text, same hosting footprint clues in domain names), paid-link networks, expired-domain redirects. If you see them, tell me which competitor and which links. Don’t recommend I replicate those.
Link opportunity shortlist — from the combined set of referring domains across all 5 competitors, give me the top 15 domains that link to multiple competitors (i.e., 2+ of the 5). These are the highest-probability link targets for outreach. Rank them by (a) how many of my competitors they link to, then (b) DR.
Output format
...
Pace yourself. Ahrefs will throttle if you hammer it. Between competitor drill-downs, wait 3–5 seconds. If you hit a rate-limit message, wait 60 seconds and retry once.
Don’t export CSVs unless I specifically ask — Ahrefs exports burn credits from my quota. Copy data from the visible UI.
Don’t navigate away from Ahrefs unless step 2.5 requires it (checking a referring domain’s topic). Always come back to the report you were on.
If a filter doesn’t apply (e.g., the “one link per domain” toggle is missing on a particular view), tell me before guessing — don’t silently proceed with bad data.
Screenshots: take one screenshot per competitor after filters are applied so I can spot-check your work.
Stop and ask me if: the keyword returns fewer than 5 usable organic results, KD is above 80 (different strategy needed), or the top results are dominated by brand terms I can’t compete with structurally.
Begin with Phase 1. Confirm the keyword and country back to me before you click search.
How to use this
Open Cowork, make sure Chrome is running with Ahrefs already logged in.
Paste the prompt above, replacing {{KEYWORD}} and {{MY_DOMAIN}}.
Let it run Phase 1 before walking away — the confirmation step is there so you can catch a wrong-country or wrong-keyword interpretation before it burns 20 minutes on the wrong SERP.
Expect the whole thing to take 15–30 minutes depending on Ahrefs load times and how many backlinks the top pages have.
Why the prompt is built this way (senior SEO reasoning)
A few choices that aren’t obvious but matter:
Referring domains to the page, not the domain, is the number that predicts ranking — sitewide DR helps, but page-level RDs are what move a specific URL. That’s why step 1.4 captures both and phase 3 anchors the target on page-level RDs.
Filtering to dofollow + one-link-per-domain before counting is non-negotiable. Raw backlink counts are vanity — a page with 10,000 backlinks from 12 domains is weaker than a page with 80 backlinks from 80 domains. The filters force an apples-to-apples count.
Using the median rather than the mean for the target avoids the common mistake of one Forbes-tier outlier dragging the average up and making the target look unachievable. The 10–15% buffer is there because Ahrefs undercounts — their crawler misses roughly that share of real links, and your competitors’ true link counts are a bit higher than shown.
The DR tier distribution matters more than total count. Forty links averaging DR 55 beats 80 links averaging DR 20, every time. Giving the distribution as output lets you plan outreach targets realistically instead of chasing a raw number.
The “links to 2+ competitors” shortlist in step 3.5 is the single highest-ROI deliverable in this workflow — those domains have already shown they link to pages on this topic, so your pitch hit rate will be 3–5x a cold list.
How To Use These Prompts
Don’t run all prompts at once.
Here’s the order:
...
now stop reading and go run the prompts.
Sarvesh
Alventramarketing.com
